...
class Item(val name: String, val description: String, val atkModifier: Double, val defModifier: Double, val spdModifier: Double, val price: Int, val itemType: Int = 1) {
